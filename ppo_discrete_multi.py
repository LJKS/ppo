...
class PPO_model:
    ...
    def save(self, file_name):
        with self.graph.as_default():
            print(self.saver.save(sess=self.session, save_path=file_name, global_step=self.iteration))

    def restore(self, file_name):
        with self.graph.as_default():
            restore_name = file_name + '-' + str(self.iteration)
            self.saver.restore(self.session, restore_name)
